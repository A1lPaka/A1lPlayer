...
class MenuBarConfigurator:
    ...
    def _rebuild_recent_menu(self):
        ...
        items = self.main_window.get_recent_media()
    ...
    def _rebuild_audio_track_menu(self):
        ...
        current_track = self.main_window.get_current_audio_track()
    ...
    def _rebuild_subtitle_track_menu(self):
        ...
        current_track = self.main_window.get_current_subtitle_track()
    ...
    def _on_exit_after_current(self, checked: bool):
        self.main_window.exit_after_current(checked)
